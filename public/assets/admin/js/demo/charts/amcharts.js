$(document).ready(function () {
    ...
    //AMCHARTS
    var barlinechart = AmCharts.makeChart("bar-line-chart", {
        "type": "serial",
        "addClassNames": true,
        "autoMargins": false,
        "marginLeft": 30,
    ...
    var lineareachart = AmCharts.makeChart("line-area-value-axis", {
        "type": "serial",
        "theme": "none",
        "legend": {
            "equalWidths": false,
    ...
    var animatedpiechart = AmCharts.makeChart("animated-pie-chart", {
        "type": "pie",
        "theme": "light",
        "dataProvider": [],
        "valueField": "size",
     ...
     * Create the map
     */
    var mapchart = AmCharts.makeChart("map-chart", {
        "type": "map",
        "theme": "light",
     ...
     * Create the map
     */
    var capitalsmapchart = AmCharts.makeChart("capital-map-chart", {
        "type": "map",
        "projection": "winkel3",
        "theme": "light",
        "imagesSettings": {
