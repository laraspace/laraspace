...
mix.combine([
    ...
    pluginPath + 'Chartjs/sparkline/jquery.sparkline.js',
    pluginPath + 'Chartjs/amcharts/amcharts.js',
    pluginPath + 'Chartjs/amcharts/serial.js',
    pluginPath + 'Chartjs/amcharts/amstock.js',
    pluginPath + 'Chartjs/amcharts/xy.js',
    pluginPath + 'Chartjs/amcharts/ammap.js',
    pluginPath + 'Chartjs/amcharts/worldLow.js',
    pluginPath + 'Chartjs/amcharts/pie.js',
    pluginPath + 'Chartjs/amcharts/animate.js',
    pluginPath + 'Chartjs/amcharts/export.js',
    pluginPath + 'Chartjs/amcharts/radar.js',
    pluginPath + 'Chartjs/amcharts/polarScatter.js',
    pluginPath + 'Chartjs/amcharts/light.js',
    pluginPath + 'Chartjs/morris/raphael.js',
    pluginPath + 'Chartjs/morris/morris.js',
    pluginPath + 'Chartjs/gauges/gauge.js',
