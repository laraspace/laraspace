...
@section('content')
    <div class="main-content">
        <div class="page-header">
            <h3 class="page-title">Image Zoom</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.components.ratings.star')}}">Components</a></li>
                <li class="breadcrumb-item active">Image Zoom</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-sm-12">
